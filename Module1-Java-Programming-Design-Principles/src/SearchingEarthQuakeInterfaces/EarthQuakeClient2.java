...
public class EarthQuakeClient2 {
    ...
    public void matchAllFilter() {
         ...
         System.out.println( maf.getName() + " and count = " + count);
    	
    }
 public void matchAllFilter2() {
     ...
     Filter f2 = new DistanceFilter(3000000,l);
     maf.addFilter(f2);
...
//         Filter f1 = new DistanceFilter(10000000,l);
